...
(d=0)):"第一筆"==b?d=0:"前一筆"==b?(d=0<=e?d-e:0,0>d&&(d=0)):"下一筆"==b?d+e<f&&(d+=e):"最後一筆"==b?d=Math.floor((f-1)/e)*e:aa(a,0,"Unknown paging action: "+b,5);b=a._iDisplayStart!==d;a._iDisplayStart=d;b&&(I(a,null,"page",[a]),c&&fa(a));return b}function Kb(a){return k("<div/>",{id:a.aanFeatures.r?null:a.sTableId+"_processing","class":a.oClasses.sProcessing}).html(a.oLanguage.sProcessing).insertBefore(a.nTable)[0]}function U(a,b){a.oFeatures.bProcessing&&k(a.aanFeatures.r).css("display",b?"block":"none");
...
fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"第一筆",sLast:"最後一筆",sNext:"下一筆",sPrevious:"前一筆"},sEmptyTable:"查無任何資料",sInfo:"顯示 _START_ 到 _END_ 筆，總筆數為 _TOTAL_ 筆",sInfoEmpty:"顯示 0 到 0 筆，總筆數為 0 筆",sInfoFiltered:"(filtered from _MAX_ total entries)",
sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Show _MENU_ entries",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"收尋:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"未發現任何符合資料"},oSearch:k.extend({},u.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};G(u.defaults);u.defaults.column={aDataSort:null,
...
sScrollFoot:"dataTables_scrollFoot",sScrollFootInner:"dataTables_scrollFootInner",sHeaderTH:"",sFooterTH:"",sSortJUIAsc:"",sSortJUIDesc:"",sSortJUI:"",sSortJUIAscAllowed:"",sSortJUIDescAllowed:"",sSortJUIWrapper:"",sSortIcon:"",sJUIHeader:"",sJUIFooter:""});var ec=u.ext.pager;k.extend(ec,{simple:function(a,b){return["前一筆","下一筆"]},full:function(a,b){return["第一筆","前一筆","下一筆","最後一筆"]},numbers:function(a,b){return[Ba(a,b)]},simple_numbers:function(a,b){return["前一筆",Ba(a,b),"下一筆"]},
full_numbers:function(a,b){return["第一筆","前一筆",Ba(a,b),"下一筆","最後一筆"]},first_last_numbers:function(a,b){return["第一筆",Ba(a,b),"最後一筆"]},_numbers:Ba,numbers_length:7});k.extend(!0,u.ext.renderer,{pageButton:{_:function(a,b,c,d,e,f){var g=a.oClasses,h=a.oLanguage.oPaginate,l=a.oLanguage.oAria.paginate||{},n,m,p=0,t=function(x,r){var A,E=g.sPageButtonDisabled,H=function(B){kb(a,B.data.action,!0)};var W=0;for(A=r.length;W<A;W++){var M=r[W];if(Array.isArray(M)){var C=k("<"+(M.DT_el||"div")+"/>").appendTo(x);
t(C,M)}else{n=null;m=M;C=a.iTabIndex;switch(M){case "ellipsis":x.append('<span class="ellipsis">&#x2026;</span>');break;case "第一筆":n=h.sFirst;0===e&&(C=-1,m+=" "+E);break;case "前一筆":n=h.sPrevious;0===e&&(C=-1,m+=" "+E);break;case "下一筆":n=h.sNext;if(0===f||e===f-1)C=-1,m+=" "+E;break;case "最後一筆":n=h.sLast;if(0===f||e===f-1)C=-1,m+=" "+E;break;default:n=a.fnFormatNumber(M+1),m=e===M?g.sPageButtonActive:""}null!==n&&(C=k("<a>",{"class":g.sPageButton+" "+m,"aria-controls":a.sTableId,"aria-label":l[M],
